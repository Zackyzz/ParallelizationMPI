...
int main(int argc, char** argv) {
	...
	FILE* m1 = fopen("C:/Users/desktop/source/repos/matrixP/qqq.txt", "r");
	fscanf(m1, "%d %d", &r1, &c1);
	FILE* m2 = fopen("C:/Users/desktop/source/repos/matrixP/m12.txt", "r");
	fscanf(m2, "%d %d", &r2, &c2);
	FILE* m3 = fopen("C:/Users/desktop/source/repos/matrixP/qtt.txt", "w");
	fprintf(m3, "%d %d\n", r1, c2);
	...
	if (world_rank == 0) {
		...
		printf("It took %f to compute the product and %f to comunicate", 1000 * time, 1000 * (time2 - time));
